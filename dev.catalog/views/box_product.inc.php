      ...
      <div class="row" style="margin: 0;">
        ...
        <div class="col-md-6">
          ...
          <div class="social-bookmarks text-center">
            ...
            <a class="facebook" href="<?php echo document::href_link('https://www.facebook.com/sharer.php', ['u' => $link]); ?>" target="_blank" title="<?php echo strtr(language::translate('text_share_on_s', 'Share on %s'), ['%s' => 'Facebook']); ?>"><?php echo functions::draw_fonticon('fa-facebook fa-lg', 'style="color: #3b5998;"'); ?></a>
            <a class="twitter" href="<?php echo document::href_link('https://twitter.com/intent/tweet/', ['text' => $name .' - '. $link]); ?>" target="_blank" title="<?php echo strtr(language::translate('text_share_on_s', 'Share on %s'), ['%s' => 'Twitter']); ?>"><?php echo functions::draw_fonticon('fa-twitter fa-lg', 'style="color: #000;"'); ?></a>
            <a class="pinterest" href="<?php echo document::href_link('https://pinterest.com/pin/create/button/', ['url' => $link]); ?>" target="_blank" title="<?php echo strtr(language::translate('text_share_on_s', 'Share on %s'), ['%s' => 'Pinterest']); ?>"><?php echo functions::draw_fonticon('fa-pinterest fa-lg', 'style="color: #bd081c;"'); ?></a>
          </div>
